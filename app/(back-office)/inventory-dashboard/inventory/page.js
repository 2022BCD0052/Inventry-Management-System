...
import { Boxes, ChartNoAxesGantt, Component, LayoutGrid, LayoutPanelTop, Scale, ScrollText, Shirt, SwatchBook, Warehouse } from 'lucide-react'
...
const optionCards = [
  ...
  {
    title : "Adjustments",
    description : "Transfer Stock from the main WareHouse to the specified amount of items",
